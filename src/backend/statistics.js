 ...
 * Player statistics, matchup analysis, and global stats
 */
 ...
 */
export function calcolaStatisticheGlobali(classifica, numeroPartite) {
 ...
 */
export function calcolaStatisticheGiocatore(partite, playerName) {
    const giocatori = {};
    const matchHistory = [];
 ...
 */
export function calcolaStatisticheMatchup(partite, classifica) {
    const matchups = {};
 ...
 */
export function trovaMatchupInteressanti(partite, classifica) {
 ...
 */
export function calcolaMatchupGiocatore(partite, playerName, classifica) {
    const matchups = {};
