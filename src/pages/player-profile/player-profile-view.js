      ...
      <div class="bg-card rounded-2xl shadow-lg overflow-hidden mb-5">
        ...
        <div class="divide-y divide-border">
          ${[...matchHistory].reverse().map(match => {
            ...
            return `
              <div class="flex items-center p-4 cursor-pointer hover:bg-accent/50 transition-colors ${resultClass}" onclick="window.location.href='../quote/quote.html?player1=${encodeURIComponent(playerData.nome)}&player2=${encodeURIComponent(match.opponent)}'">
